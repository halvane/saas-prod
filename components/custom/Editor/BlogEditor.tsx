...
Switch to LED bulbs, unplug devices when not in use, and consider renewable energy sources for your home.`);
  ...
  const [tags, setTags] = useState<string[]>(variant?.tags || ['sustainability', 'eco-friendly', 'green-living']);
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="📝 Blog Post Editor" size="full">
      <ModalContent>
